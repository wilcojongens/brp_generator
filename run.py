...
parser.add_argument("--aantal_dossiers", type=int, default=DEFAULT_AANTAL_DOSSIERS, help="Aantal dossiers per bestand")
parser.add_argument("--aantal_bestanden", type=int, default=DEFAULT_AANTAL_BESTANDEN, help="Aantal bestanden per serie")
parser.add_argument("--leeftijd", type=int, default=DEFAULT_LEEFTIJD, help="Leeftijd van de gegenereerde personen")
parser.add_argument("--brin", type=str, default=BRIN_CODE, help="BRIN-code van de school")
parser.add_argument("--klas_of_groep", type=str, default=KLAS_OF_GROEP, help="Klas of groep aanduiding")
    ...
    with open(bestandsnaam, "w", encoding="utf-8") as f:
        for r in records:
            ...
            a_regel = (
                ...
                f"{' ' * 11}{a_nummer}BATCH{' ' * 45}N00000  00000000A00000000{' ' * 13}0000{' ' * 10}{r['bsn']}{' ' * 17}00000{' ' * 41}X\n"
            )
